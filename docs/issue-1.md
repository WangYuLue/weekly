...
<video id="video" controls="" preload="none" poster="http://phgxcuckd.bkt.clouddn.com/image/blog/181101_4.jpg">
    <source id="mp4" src="http://phgxcuckd.bkt.clouddn.com/video/181101_1.mp4" type="video/mp4">
</video>
...
![Alt text](http://phgxcuckd.bkt.clouddn.com/120.webp)

这只甲虫在从缅甸北部一个山谷的琥珀中被发现，它是是现代碎屑栖息的甲虫的祖先，但是这种甲虫目前只生活在南美洲，

![Alt text](http://phgxcuckd.bkt.clouddn.com/ss.webp)

这发现可能显示了南半球与缅甸之间的一些惊人联系，或许与今天不同，缅甸曾经位于南半球。

### 4、[太阳能食品](http://www.solarfoods.fi/)

![Alt text](http://phgxcuckd.bkt.clouddn.com/image/blog/Solar_Foods_Pic2-768x512.jpg)
...
![Alt text](http://phgxcuckd.bkt.clouddn.com/dims%20%281%29.jpeg)
...
![Alt text](http://phgxcuckd.bkt.clouddn.com/dims%20%282%29.jpeg)

在机身设计方面，新款 iPad Pro 也一改之前的圆润，变得更加的方正，大概就类似于早前 iPhone 5 的设计。

### 6、[从角膜反射中提取的可识别图像](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0083325)
![Alt text](http://phgxcuckd.bkt.clouddn.com/journal.pone.0083325.g002.png)

刑事调查经常使用照片证据来识别嫌犯。在这里，结合强大的人脸感知和高分辨率摄影，可以挖掘隐藏的面部信息。通过放大高分辨率的脸部照片，我们能够从受试者眼睛的反射中恢复看不见的旁观者的图像。这可能有助于识别犯罪者。

上图A的宽度为5412像素，高度为7,216像素（总共39,052,922像素）。整个面部区域（不包括头发）平均约为1200万像素，图B虹膜区域平均约占54,000像素，占整个面部区域的0.5％。图c角膜反射的人物图像宽27到36像素，高42到56像素。反射旁观者的整个面部区域平均为322个像素，或者为摄影对象的整个面部区域的约0.003％。
...
![Alt text](http://phgxcuckd.bkt.clouddn.com/67F7EEE7-9DEE-4794-9B4A21A34A06FD14_source.jpg)

官方是根据一个有着139年历史的铂金和铱的小圆柱来定义一公斤质量，它位于巴黎附近的一个三重锁定的拱顶中。因为它非常重要，科学家几乎从不把它拿出来; 但是每次拿出来，放在秤上都会留下几个金属原子，这就意味着它不再准确。

这就是公斤很快可能不是通过物理对象而是通过基于基本常数的计算重新定义的原因之一。
...
<video id="video" controls="" preload="none" poster="http://phgxcuckd.bkt.clouddn.com/DpauHwQWwAYLpHp.jpg">
    <source id="mp4" src="http://phgxcuckd.bkt.clouddn.com/image/blog/DpauHwQWwAYLpHp.mp4" type="video/mp4">
</video>

### 2、[三趾树懒](https://www.instagram.com/p/BpgjgGNDDEJ/?utm_source=ig_web_button_share_sheet)

![Alt text](http://phgxcuckd.bkt.clouddn.com/image/blog/181101_1.jpg)
...
![Alt text](http://phgxcuckd.bkt.clouddn.com/image/blog/44341446_134554794185008_8335939179629622725_n.jpg)
游客们在圣马可广场的洪水中跋涉，这是水城威尼斯十年来最严重的洪水；

### 2、[世界上最大的雕像](https://www.instagram.com/p/Bpmzet_F64d/?utm_source=ig_web_button_share_sheet)
![Alt text](http://phgxcuckd.bkt.clouddn.com/image/blog/44207512_714348095601626_651976763205511483_n.jpg)
...
![Alt text](http://phgxcuckd.bkt.clouddn.com/wechat-qcode.jpg)